...
This documentation provides comprehensive guidance for using proton, a Go library designed to help you build better software.

## Project Information

- **Repository**: [https://github.com/kolosys/proton](https://github.com/kolosys/proton)
- **Import Path**: `github.com/kolosys/proton`
- **License**: MIT
- **Version**: latest
...
- **discovery** - 
- **generator** - 
- **interfaces** - Package interfaces provides core interfaces for Proton documentation generation.
...
- **GitHub Issues**: [https://github.com/kolosys/proton/issues](https://github.com/kolosys/proton/issues)
- **Discussions**: [https://github.com/kolosys/proton/discussions](https://github.com/kolosys/proton/discussions)
...
Ready to get started? Head over to the [Installation Guide](installation.md) to begin using proton.

Custom content in getting-started
