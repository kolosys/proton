...
cleanOutputDirectory removes all files from the output directory If PreserveCustom is enabled, it only removes auto-generated directories
...
isInitialization checks if this is the first time documentation is being generated by checking if core-concepts or advanced directories exist
